  ...
  <v-sheet height="100vh" class="overflow-hidden"
    ...
    <v-navigation-drawer permanent expand-on-hover>
      <v-list class="d-flex flex-column justify-center align-center">
        ...
        <v-list-item link>
          <v-list-item-content>
            <v-list-item-subtitle>email adresi</v-list-item-subtitle>
          </v-list-item-content>
        </v-list-item>
      </v-list>
      ...
      <v-list nav dense>
        ...
        <router-link to="/admin-dashboard/tour-lists" class="menu link">
          <v-list-item link>
            ...
            <v-list-item-title>Turlar</v-list-item-title>
          </v-list-item>
        </router-link>
        <router-link to="/admin-dashboard/tour-packages" class="menu link">
          <v-list-item link>
            ...
            <v-list-item-title>Tur Paketleri</v-list-item-title>
          </v-list-item>
        </router-link>
        <router-link to="/admin-dashboard/weather-forecast" class="menu link">
          <v-list-item link>
            ...
            <v-list-item-title>Hava Durumu</v-list-item-title>
          </v-list-item>
        </router-link>
